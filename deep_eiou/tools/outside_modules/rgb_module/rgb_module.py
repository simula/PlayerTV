...
from tools.outside_modules.rgb_module.distance_metrics_rgb import weighted_RGB, to_cielab
from tools.outside_modules.rgb_module.get_crop_offset import get_crop_center_offset, get_crop_trim_offset, parse_offset

color_space = {"weighted_rgb": weighted_RGB, "CIELAB": to_cielab}
...
class RGBModule:
    def __init__(self, parameters: dict):
        ...
        self.iou = parameters["sample_non_overlapping_boxes_only"]
