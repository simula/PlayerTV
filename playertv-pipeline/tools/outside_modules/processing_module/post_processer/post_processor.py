...
from .helper_functions.get_ocr_results import split_into_time_zones, top_n_scores, brute_force
...
get_ocr = {"split_into_time_zones": split_into_time_zones, "brute_force": brute_force, "top_n_scores": top_n_scores}
...
class PostProcessor(Processor):
    def __init__(self, parameters, rgb_module, ocr_module, predictor):
        ...
        try:
            ...
            pass
        try:
            self.n = parameters["params"]["top_n"]
        except:
            pass
            ...
            for value in values:
                for track_id, details in value.items():
                    ...
                    entry = {track_id: {
                        ...
                        "kit_number": f"{myentry['name']} ({myentry['kit_number']})"
                    }}
        ...
        for track in track_idb_list:
            ...
            if overlap1 or overlap2:
                ...
                if valuesa[0]["score"] > valuesb[0]["score"]:
                    self.team_player_dict[track_ida] = {"team": strip_list[0]["team"], "kit_number": kit_num, "name": strip_list[0]["player_name"]}
                    strip_list = valuesb
                    top_list = valuesa
